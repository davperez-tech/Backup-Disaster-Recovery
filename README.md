...
│              │                      │                      │        │
│     ┌────────┴───────┐   ┌─────────┴────────┐   ┌────────┴──────┐  │
│     │     DC01       │   │     BKP01        │   │  SRV-LINUX01  │  │
│     │ 192.168.10.10  │   │ 192.168.10.30    │   │ 192.168.10.20 │  │
│     │                │   │                  │   │               │  │
│     │ • AD DS + DNS  │   │ • Veeam B&R v13  │   │ • Ubuntu 24.04│  │
│     │ • Group Policy │   │ • Backup Repo    │   │ • SSH Server  │  │
│     │ • NTP Source   │   │   (E:\Backups)   │   │ • Veeam Agent │  │
│     └────────────────┘   │ • Veeam Agent    │   └───────────────┘  │
│                          └────────┬─────────┘                       │
│     ┌────────────────┐            │                                 │
│     │  WIN11-CLIENT  │            │  Backup Copy Job                │
│     │ 192.168.10.103 │            │  (Immutable)                    │
│     │ (DHCP Reserv.) │            ▼                                 │
│     │ • Domain-joined│   ┌────────────────┐                         │
│     │ • Veeam Agent  │   │   AWS S3       │                         │
│     └────────────────┘   │   Object Lock  │                         │
